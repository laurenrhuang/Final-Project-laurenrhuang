...
The first step is to install packages for any functions or models we'll need to fit. For the framework of our models, we'll be using tidymodels.
...
Let's add a variable called "course" so we know which observations are from which dataset. This is important because later we will be merging and/or splitting the dataset, so we want to keep track.
...
Let's make 2 recipes (same as above) for the classification models with the data, except this time our outcome G3 is a factor.
...
# write file
write_rds(tune_res_elasticnet, file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131/Final-Project/Final-Project-laurenrhuang/tune_res_elasticnet.rds")
```

```{r}
# read file
tune_res_elasticnet <- read_rds(file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131//Final-Project/Final-Project-laurenrhuang/tune_res_elasticnet.rds")
...
# write file
write_rds(tune_res_elasticnet2, file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131/Final-Project/Final-Project-laurenrhuang/tune_res_elasticnet2.rds")
```

```{r}
# read file
tune_res_elasticnet2 <- read_rds(file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131/Final-Project/Final-Project-laurenrhuang/tune_res_elasticnet2.rds")
...
As we saw above, it seems like Method 1. merged dataset gave us better accuracy when fitted to the elastic net model. Let's investigate the details of this model by calculating AUC, roc_auc, and plotting ROC curves. We also make a heatmap confusion matrix.
...
# write file
write_rds(tune_res, file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131/Final-Project/Final-Project-laurenrhuang/classtree_tune_res.rds")
```

```{r}
# read file
classtree_tune_res <- read_rds(file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131/Final-Project/Final-Project-laurenrhuang/classtree_tune_res.rds")
...
# roc_auc
predicted_data <- augment(classtree_final1_fit, new_data = grades_train_fctr) %>%
  select(g3, starts_with(".pred"))
predicted_data %>% roc_auc(g3, .pred_Fail)
```
...
# write file
write_rds(classtree_tune_res2, file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131/Final-Project/Final-Project-laurenrhuang/classtree_tune_res2.rds")
```

```{r}
# read file
classtree_tune_res2 <- read_rds(file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131/Final-Project/Final-Project-laurenrhuang/classtree_tune_res2.rds")
# cost-complexity accuracy autoplot
...
# roc_auc
predicted_data <- augment(classtree_final_fit2, new_data = grades_train2_fctr_nocourse) %>%
  select(g3, starts_with(".pred"))
predicted_data %>% roc_auc(g3, .pred_Fail)
```
...
# write file
write_rds(boostedtree_tune_res, file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131/Final-Project/Final-Project-laurenrhuang/boostedtree_tune_res.rds")
```

```{r}
# read file
boostedtree_tune_res <- read_rds(file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131/Final-Project/Final-Project-laurenrhuang/boostedtree_tune_res.rds")
...
predicted_data2 <- augment(xgb_final_fit1, new_data = grades_train_fctr) %>%
  select(g3, starts_with(".pred"))

# roc_auc
predicted_data2 %>% roc_auc(g3, .pred_Fail)
```
...
# write file
write_rds(boostedtree_tune_res2, file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131/Final-Project/Final-Project-laurenrhuang/boostedtree_tune_res2.rds")
```

```{r}
# read file
boostedtree_tune_res2 <- read_rds(file = "C:/Users/cupca/OneDrive/Documents/UCSB/Fall2022/PSTAT131/Final-Project/Final-Project-laurenrhuang/boostedtree_tune_res2.rds")
...
predicted_data2 <- augment(xgb_final_fit2, new_data = grades_train2_fctr_nocourse) %>%
  select(g3, starts_with(".pred"))
